...
def get(chart_name=None, chart=None, no_cache=None, filters=None, from_date=None,
    ...
    axis_labels = []
    flow_measurements = []
    flow_measurements, axis_labels = get_flow_measurement(projects, filters)
...
def get_flow_measurement(projects, filters):
    ...
    s_sql = f"""
                ...
                as twm
                group by twm.project
                order by twm.project
                """;
    ...
    return flow_volume_list, axis_labels
...
def get_project_for_customer(customer_name):
